...
#         """
#         Create and return a new `Snippet` 'Snippet' instance, given the validated data.
#         """
#         return Snippet.objects.create(**validated_data)
#
#     def update(self, instance, validated_data):
#         """
#         Update and return an existing 'Snippet' `Snippet` instance, given the validated data.
#         """
